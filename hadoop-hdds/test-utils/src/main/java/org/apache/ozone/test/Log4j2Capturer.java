...
final class Log4j2Capturer extends GenericTestUtils.LogCapturer {
  ...
  public static Log4j2Capturer getInstance(Class<?> clazz) {
    INSTANCE.defineLogCaptor(clazz);
    return INSTANCE;
  }

  public static Log4j2Capturer getInstance(String name) {
    INSTANCE.defineLogCaptor(name);
    return INSTANCE;
  }
