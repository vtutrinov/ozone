...
public interface StorageContainerLocationProtocol extends Closeable {
  ...
  /**
   * Returns ordered container summary report generated by Replication
   * Manager with target containers quantity.
   * @return The latest ReplicationManagerReport.
   * @throws InterruptedException
   */
  default ReplicationManagerReport orderContainerManagerReport(int count)
      throws InterruptedException {
