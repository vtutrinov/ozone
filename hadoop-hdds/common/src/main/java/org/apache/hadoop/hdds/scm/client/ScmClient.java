...
public interface ScmClient extends Closeable {
  ...
  /**
   * Returns the container summary report generated by Replication
   * Manager with target samples quantity >= {@code ReplicationManagerReport.SAMPLE_LIMIT}.
   * @return The latest ReplicationManagerReport.
   * @throws InterruptedException
   */
  ReplicationManagerReport orderContainerManagerReport(int count)
      throws InterruptedException;
